    ...
    <div class="article_content">
      <div class="article-text">
        ...
        <div class="metabox1"> 
          ...
          <span class="entry-comments"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','digital-marketing-lite'), __('0 Comments','digital-marketing-lite'), __('% Comments','digital-marketing-lite') ); ?></span>
        </div>
