...
function marketing_agency_admin_theme_style() {
   wp_enqueue_style( 'marketing-agency-font', marketing_agency_admin_font_url(), array() );
...
// Theme Font URL
function marketing_agency_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="marketing_agency_open_tab(event, 'theme_lite')"><?php esc_html_e( 'Getting Started', 'marketing-agency' ); ?></button>		  
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-format-image"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[control]=custom_logo') ); ?>" target="_blank"><?php esc_html_e('Upload your logo','marketing-agency'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=marketing_agency_top_header') ); ?>" target="_blank"><?php esc_html_e('Top Header','marketing-agency'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=marketing_agency_slidersettings') ); ?>" target="_blank"><?php esc_html_e('Slider Section','marketing-agency'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-align-center"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=marketing_agency_footer') ); ?>" target="_blank"><?php esc_html_e('Footer Text','marketing-agency'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-editor-aligncenter"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=nav_menus') ); ?>" target="_blank"><?php esc_html_e('Menus','marketing-agency'); ?></a>
							</div>
							<div class="row-box2">
								<span class="dashicons dashicons-screenoptions"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=marketing_agency_typography') ); ?>" target="_blank"><?php esc_html_e('Typography','marketing-agency'); ?></a>
							</div>
						</div>

						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=marketing_agency_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','marketing-agency'); ?></a>
							</div>
							 <div class="row-box2">
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( MARKETING_AGENCY_BUY_NOW ); ?>"><?php esc_html_e('Buy Pro', 'marketing-agency'); ?></a>
