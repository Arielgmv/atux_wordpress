...
function marketing_agency_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('marketing_agency_loader_icon',array(
        'default' => 'Two Way',
        'sanitize_callback' => 'marketing_agency_sanitize_choices'
	));
	$wp_customize->add_control('marketing_agency_loader_icon',array(
        'type' => 'select',
        'label' => esc_html__('Pre-Loader Type','marketing-agency'),
        'section' => 'marketing_agency_left_right',
        'choices' => array(
            'Two Way' => esc_html__('Two Way','marketing-agency'),
            'Dots' => esc_html__('Dots','marketing-agency'),
            'Rotate' => esc_html__('Rotate','marketing-agency')
        ),
	) );
	...
	$wp_customize->add_setting('marketing_agency_email_address',array(
		'default'=> '',
		'sanitize_callback'	=> 'marketing_agency_sanitize_email'
	));	
	...
	$wp_customize->add_setting( 'marketing_agency_metabox_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'marketing_agency_switch_sanitization'
    ));  
    $wp_customize->add_control( new Marketing_Agency_Toggle_Switch_Custom_Control( $wp_customize, 'marketing_agency_metabox_hide_show',array(
      	'label' => esc_html__( 'Show / Hide Metabox','marketing-agency' ),
      	'section' => 'marketing_agency_responsive_media'
    )));
	...
	$wp_customize->add_setting('marketing_agency_copyright_alingment',array(
        'default' => 'center',
        'sanitize_callback' => 'marketing_agency_sanitize_choices'
	));
	$wp_customize->add_control(new Marketing_Agency_Image_Radio_Control($wp_customize, 'marketing_agency_copyright_alingment', array(
        'type' => 'select',
        'label' => esc_html__('Copyright Alignment','marketing-agency'),
        'section' => 'marketing_agency_footer',
        'settings' => 'marketing_agency_copyright_alingment',
        'choices' => array(
