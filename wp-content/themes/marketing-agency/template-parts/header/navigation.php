            ...
            <?php $blog_info = get_bloginfo( 'name' ); ?>
              <?php if ( ! empty( $blog_info ) ) : ?>
                <?php if ( is_front_page() && is_home() ) : ?>
                  <?php if( get_theme_mod('marketing_agency_logo_title_hide_show',true) != ''){ ?>
              ...
              ?>
              <?php if( get_theme_mod('marketing_agency_tagline_hide_show',true) != ''){ ?>
        ...
        <div class="col-lg-9 col-md-8 col-3">
          <?php if(has_nav_menu('primary')){ ?>
            <div class="toggle-nav mobile-menu text-md-right my-md-2">
              <button role="tab" onclick="marketing_agency_menu_open_nav()" class="responsivetoggle"><i class="fas fa-bars p-3"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','marketing-agency'); ?></span></button>
            </div>
          <?php } ?>
          <div id="mySidenav" class="nav sidenav">
            <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'marketing-agency' ); ?>">
              ...
              <a href="javascript:void(0)" class="closebtn mobile-menu" onclick="marketing_agency_menu_close_nav()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Button','marketing-agency'); ?></span></a>
            </nav>
          </div>
        </div>
      </div>
