    ...
    <div class="row">
      <div class="col-lg-3 col-md-3">
        <?php if( get_theme_mod('marketing_agency_email_address_text') != '' || get_theme_mod('marketing_agency_email_address') != '' ){ ?>
          <p class="py-2 py-lg-3 py-md-3 mb-0"><i class="far fa-envelope mr-2"></i><?php echo esc_html(get_theme_mod('marketing_agency_email_address_text',''));?>: <?php echo esc_html(get_theme_mod('marketing_agency_email_address',''));?></p>
        <?php } ?>
      </div>
      <div class="col-lg-2 col-md-2">
        <?php if( get_theme_mod('marketing_agency_phone_number_text') != '' || get_theme_mod('marketing_agency_phone_number') != '' ){ ?>
          <p class="py-2 py-lg-3 py-md-3 mb-0"><i class="fas fa-phone mr-2"></i><?php echo esc_html(get_theme_mod('marketing_agency_phone_number_text',''));?>: <?php echo esc_html(get_theme_mod('marketing_agency_phone_number',''));?></p>
        <?php } ?>
      </div>
